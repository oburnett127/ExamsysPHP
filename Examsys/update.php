...
if(isset($_SESSION['key'])){
  if(@$_GET['fdid'] && $_SESSION['key']=='oburn7785068889') {
    $id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
  if(@$_GET['demail'] && $_SESSION['key']=='oburn7785068889') {
    $demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
  if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='oburn7785068889') {
    $eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
  if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='oburn7785068889') {
    $name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
  if(@$_GET['q']== 'addqns' && $_SESSION['key']=='oburn7785068889') {
    $n=@$_GET['n'];
    $eid=@$_GET['eid'];
    $ch=@$_GET['ch'];
...
//quiz start
//$correct is the num of points to add to score for each correct answer
//$wrong is the num of points to subtract from the score for each wrong answer
if(@$_GET['q']== 'quiz' && @$_GET['step']== 2) {
  ...
  else if( $_SESSION['key']!='oburn7785068889')
  {
